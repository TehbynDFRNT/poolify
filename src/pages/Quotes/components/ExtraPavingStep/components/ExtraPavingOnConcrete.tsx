...
import { useConcreteCostCalculator } from "../../ExtraPavingConcreteStep/hooks/useConcreteCostCalculator";
import { CostBreakdown } from "../../ExtraPavingConcreteStep/components/CostBreakdown";
import { PavingTypeSelector } from "../../ExtraPavingConcreteStep/components/PavingTypeSelector";
import { MetersInput } from "../../ExtraPavingConcreteStep/components/MetersInput";
import { NavigationButtons } from "../../ExtraPavingConcreteStep/components/NavigationButtons";

export const ExtraPavingOnConcrete = () => {
  ...
  return (
    <Card className="border border-gray-200">
      <CardHeader className="bg-white pb-2">
        <h2 className="text-xl font-semibold">Extra Paving on Concrete</h2>
