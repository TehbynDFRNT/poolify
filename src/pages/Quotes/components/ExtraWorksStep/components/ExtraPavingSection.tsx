...
export type ExtraPavingSectionRef = {
  getCurrentPavingSelections: () => any[];
  getCurrentTotalCost: () => number;
  getCurrentTotalMargin: () => number;
};

export const ExtraPavingSection = forwardRef<ExtraPavingSectionRef, {}>(
  (props, ref) => {
    const {
      pavingCategories,
      concreteLabourCosts,
    ...
    // Expose current state through the ref
    useImperativeHandle(ref, () => ({
      getCurrentPavingSelections: () => {
        console.log("Getting current paving selections:", pavingSelections);
        return [...pavingSelections];
      },
      getCurrentTotalCost: () => {
        console.log("Getting current total cost:", totalCost);
        return totalCost;
      },
      getCurrentTotalMargin: () => {
        console.log("Getting current total margin:", totalMargin);
        return totalMargin;
      }
    }));
...
ExtraPavingSection.displayName = "ExtraPavingSection";
