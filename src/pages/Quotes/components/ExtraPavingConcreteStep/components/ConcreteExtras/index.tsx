...
import { SquareDashedBottom, Truck, Scissors } from "lucide-react";
...
import { ConcreteCutSelection } from "@/pages/Quotes/components/ExtraPavingStep/types";
...
export const ConcreteExtras: React.FC = () => {
  ...
  useEffect(() => {
    const totalCost = selectedCuts.reduce((total, cut) => 
