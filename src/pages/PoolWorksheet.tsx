...
const PoolWorksheet = () => {
  ...
  useEffect(() => {
    toast.info("Pool worksheet updated", {
      description: "Now showing pool name, range, buy prices, fixed costs, filtration costs, and crane costs."
    });
  }, []);
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              {isDataEmpty 
                ...
                : "Showing pool details, pricing, fixed costs, filtration costs, and crane costs"}
            </p>
          </div>
        </div>
