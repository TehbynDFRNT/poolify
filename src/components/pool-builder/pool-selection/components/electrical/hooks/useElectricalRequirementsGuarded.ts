...
import { ElectricalData, ElectricalOption } from "../types";

export const useElectricalRequirementsGuarded = (poolId: string, customerId: string | null) => {
    ...
    // Create a guarded mutation to save electrical requirements
    const {
        mutate: saveElectricalMutation,
        isPending: isSaving,
        StatusWarningDialog
    } = useGuardedMutation({
